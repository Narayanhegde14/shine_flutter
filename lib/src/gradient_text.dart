...
/// The text style to apply to descendant [GradientText] widgets which don't have an
/// explicit style.
///
/// See also:
///
...
class GradientDefaultTextStyle extends InheritedTheme {
  /// Creates a default text style for the given subtree.
  ///
  /// Consider using [GradientDefaultTextStyle.merge] to inherit styling information
  ...
  const GradientDefaultTextStyle({
    super.key,
    required this.style,
    this.textAlign,
    this.softWrap = true,
  ...
  ///
  /// This constructor creates a [GradientDefaultTextStyle] with an invalid [child], which
  /// means the constructed value cannot be incorporated into the tree.
  const GradientDefaultTextStyle.fallback({super.key})
  ...
  /// ambient [GradientDefaultTextStyle] using [GradientDefaultTextStyle.of], then create a new
  /// [GradientDefaultTextStyle] using the [DefaultTextStyle.new] constructor directly.
  ...
  static Widget merge({
    ...
    return Builder(
      builder: (BuildContext context) {
        final GradientDefaultTextStyle parent =
            GradientDefaultTextStyle.of(context);
        return GradientDefaultTextStyle(
          key: key,
  ...
  /// ```
  static GradientDefaultTextStyle of(BuildContext context) {
    return context
            .dependOnInheritedWidgetOfExactType<GradientDefaultTextStyle>() ??
        const GradientDefaultTextStyle.fallback();
  }

  @override
  bool updateShouldNotify(GradientDefaultTextStyle oldWidget) {
...
/// The [TextHeightBehavior] that will apply to descendant [GradientText] and [EditableText]
/// widgets which have not explicitly set [GradientText.textHeightBehavior].
///
/// If there is a [GradientDefaultTextStyle] with a non-null [GradientDefaultTextStyle.textHeightBehavior]
/// below this widget, the [GradientDefaultTextStyle.textHeightBehavior] will be used
/// over this widget's [TextHeightBehavior].
///
/// See also:
///
///  * [GradientDefaultTextStyle], which defines a [TextStyle] to apply to descendant
///    [GradientText] widgets.
...
///
/// The [GradientText] widget displays a string of text with single style. The string
/// might break across multiple lines or might all be displayed on the same line
/// depending on the layout constraints.
///
/// The [style] argument is optional. When omitted, the text will use the style
/// from the closest enclosing [GradientDefaultTextStyle]. If the given style's
/// [TextStyle.inherit] property is true (the default), the given style will
/// be merged with the closest enclosing [GradientDefaultTextStyle]. This merging
/// behavior is useful, for example, to make the text bold while using the
/// default font family and size.
///
/// {@tool snippet}
///
/// This example shows how to display text using the [GradientText] widget with the
...
/// {@end-tool}
///
/// Using the [Text.rich] constructor, the [GradientText] widget can
...
/// ## Interactivity
///
/// To make [GradientText] react to touch events, wrap it in a [GestureDetector] widget
...
/// ## Selection
///
/// [GradientText] is not selectable by default. To make a [GradientText] selectable, one can
...
///  * [GradientDefaultTextStyle], which sets default styles for [GradientText] widgets.
///  * [SelectableRegion], which provides an overview of the selection system.
class GradientText extends StatelessWidget {
  /// Creates a text widget.
  ///
  /// If the [style] argument is null, the text will use the style from the
  /// closest enclosing [GradientDefaultTextStyle].
  ///
  ...
  /// the closest enclosing [GradientDefaultTextStyle]. Otherwise, the style will
  /// replace the closest enclosing [GradientDefaultTextStyle].
  final TextStyle? style;
  ...
  /// from the nearest [GradientDefaultTextStyle] ancestor will be used.
  final TextOverflow? overflow;
  ...
  /// edge of the box.
  ///
  /// If this is null, but there is an ambient [GradientDefaultTextStyle] that specifies
  /// an explicit number for its [GradientDefaultTextStyle.maxLines], then the
  /// [GradientDefaultTextStyle] value will take precedence. You can use a [RichText]
  /// widget directly to entirely override the [GradientDefaultTextStyle].
  final int? maxLines;
  ...
  /// in the [BuildContext] of the [GradientText] widget.
  ///
  ...
  @override
  Widget build(BuildContext context) {
    final GradientDefaultTextStyle defaultTextStyle =
        GradientDefaultTextStyle.of(context);
