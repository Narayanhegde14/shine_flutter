...
/// [RichText] does not do that automatically. The inner [GradientTextStyle] objects are
...
/// obtain a [GradientTextStyle] that doubles the default font size.
///
...
///
/// To select a custom font, create [GradientTextStyle] using the [fontFamily]
...
///    [Text] widgets, configured using a [GradientTextStyle].
///  * [RichText], the widget for showing a paragraph of mix-style text.
///  * [TextSpan], the class that wraps a [GradientTextStyle] for the purposes of
...
@immutable
class GradientTextStyle with Diagnosticable {
  ...
  const GradientTextStyle({
    ...
    this.overflow,
        ...
        _package = package,
        assert(foreground == null, _kColorForegroundWarning),
        assert(backgroundColor == null || background == null,
            _kColorBackgroundWarning);

  /// Whether null values in this [GradientTextStyle] can be replaced with their value
  /// in another [GradientTextStyle] using [merge].
  ///
  /// The [merge] operation is not commutative: the [inherit] value of the
  /// method argument decides whether the two [GradientTextStyle]s can be combined
  /// together. If it is false, the method argument [GradientTextStyle] will be returned.
  /// Otherwise, the combining is allowed, and the returned [GradientTextStyle] inherits
  ...
  ///
  /// See also:
  ///  * [GradientTextStyle.merge], which can be used to combine properties from two
  ///    [GradientTextStyle]s.
  final bool inherit;
  ...
  /// [leadingDistribution] property. See the [GradientTextStyle] class's documentation
  /// for an example.
  ///
  ...
  /// sources.
  ///
  /// Shadows must be in the same order for [GradientTextStyle] to be considered as
  ...
  /// return a [GradientTextStyle] whose [fontSize] is `style.fontSize * 2.0 + 1.0`.
  ///
  ...
  /// [GradientTextStyle] with a [FontWeight.w300].
  ///
  ...
  GradientTextStyle apply({
    ...
    return GradientTextStyle(
      inherit: inherit,
      color: foreground == null ? color ?? this.color : Colors.white,
      backgroundColor:
  ...
  /// [other] style.
  ///
  /// If the given [other] text style has its [GradientTextStyle.inherit] set to true,
  ...
  ///
  /// If the given [other] text style has its [GradientTextStyle.inherit] set to false,
  ...
  GradientTextStyle merge(GradientTextStyle? other) {
    if (other == null) {
      return this;
    }
    if (!other.inherit) {
  ...
  /// lerpable fields such as colors (for example, if one [GradientTextStyle] specified
  /// `fontSize` but the other didn't, the returned [GradientTextStyle] will use the
  /// `fontSize` from the [GradientTextStyle] that specified it, regarless of the `t`
  /// value).
  ///
  /// This method throws when the given [GradientTextStyle]s don't have the same
  /// [inherit] value and a lerpable field is missing from both [GradientTextStyle]s,
  ...
  static GradientTextStyle? lerp(
      GradientTextStyle? a, GradientTextStyle? b, double t) {
    if (a == null && b == null) {
      return null;
    }
    ...
    if (a == null) {
      return GradientTextStyle(
        inherit: b!.inherit,
        color: Color.lerp(null, b.color, t) ?? Colors.white,
    ...
    if (b == null) {
      return GradientTextStyle(
        inherit: a.inherit,
        color: Color.lerp(a.color, null, t) ?? Colors.white,
    ...
    return GradientTextStyle(
      ...
      color: a.foreground == null && b.foreground == null
          ? Color.lerp(a.color, b.color, t) ?? Colors.white
          : Colors.white,
  ...
  RenderComparison compareTo(GradientTextStyle other) {
  ...
  bool operator ==(Object other) {
    ...
    return other is GradientTextStyle &&
